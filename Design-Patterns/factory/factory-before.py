...
#1. Main() has too many responsibilities, it handles user input and creates objects directly. ALso it handles the export and preparation logic.
#2. The selection logic for exporters is tightly coupled with the main function, making it hard to extend or modify.
"""
